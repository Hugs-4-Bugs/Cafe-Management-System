...
public class ProductRestImpl implements ProductRest {
 ...
 // Pagination implementation
    @Override
    public ResponseEntity<Page<Product>> listOfProduct(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        Page<Product> productPage = productService.listOfProduct(PageRequest.of(page, size));
